...
const socialLinks = [
  { label: "Facebook",   href: "https://facebook.com/deimint",    icon: (
    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"/></svg>
  )},
  { label: "Instagram",  href: "https://instagram.com/deimint",   icon: (
    <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.8"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>
  )},
  { label: "X / Twitter", href: "https://x.com/deimint",          icon: (
    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
  )},
  { label: "DeviantArt", href: "https://deviantart.com/deimint",  icon: (
    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M18.19 5.636l-.34.34-1.57-2.976H12l-3.09 5.43-.34.34H5v4.58h2.09l.34.34L5 18.64V22h4.34l.34-.34 1.57-2.976H15l3.09-5.43.34-.34H21V9.32h-2.09l-.34-.34.62-3.344z"/></svg>
  )},
  { label: "ArtStation", href: "https://artstation.com/deimint",  icon: (
    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M0 17.723l2.027 3.505h.001a2.424 2.424 0 002.164 1.333h13.457l-2.792-4.838H0zm24 .025c0-.484-.143-.935-.388-1.314L15.728 2.728a2.424 2.424 0 00-2.164-1.333H9.419L21.598 22l1.92-3.32c.301-.52.482-1.117.482-1.932zm-11.129-3.462L7.428 4.858l-5.444 9.428h10.887z"/></svg>
  )},
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <p style={{ color: "rgba(255,255,255,0.65)", fontSize: "0.875rem", lineHeight: 1.7, maxWidth: "280px", fontFamily: "var(--font-sans)" }}>
              Creating art that tells stories through digital and traditional mediums.
            </p>
          </div>
            ...
            <ul className="space-y-3">
              {quickLinks.map(l => (
                <li key={l.label}>
                  <a
                    href={l.href}
                    onClick={l.label === "Track Order" ? (e) => { e.preventDefault(); onOpenTracker(); } : undefined}
