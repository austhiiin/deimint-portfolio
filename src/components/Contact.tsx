...
interface FormData {
  ...
  medium: string; budget: string; message: string;
}
...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 2. Also send via Formspree (replace YOUR_FORMSPREE_ID)
      // If you don't have a Formspree ID yet, remove the fetch block below
      // and messages will still be saved to Supabase
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p style={{ color: "var(--fg-muted)", maxWidth: "480px", margin: "0 auto", lineHeight: 1.7, fontSize: "0.95rem" }}>
            {commissionsOpen
              ? `Commissions open · ~${queueWeeks} week queue. Fill in the form and I'll get back within 48 hours.`
              : "Commissions are currently closed. You can still send a message for future consideration."}
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2 flex flex-col gap-5">
            {[
              { icon:"✉️", label:"Email",      value: artistEmail,    href: `mailto:${artistEmail}` },
          ...
          {/* Form */}
          <div className="lg:col-span-3 p-8 rounded-3xl"
            ...
            {status === "success" ? (
              <div className="flex flex-col items-center justify-center py-16 text-center gap-4">
                <div className="w-16 h-16 rounded-full flex items-center justify-center text-3xl"
                  style={{ background:"rgba(179,233,199,0.4)" }}>✓</div>
              ...
              <form onSubmit={handleSubmit} noValidate>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                  <div>
                    <label style={{ fontFamily:"var(--font-mono)", fontSize:"0.65rem", letterSpacing:"0.2em", textTransform:"uppercase", color:"var(--fg-subtle)", display:"block", marginBottom:"6px" }}>Name *</label>
                  ...
                  <div>
                    <label style={{ fontFamily:"var(--font-mono)", fontSize:"0.65rem", letterSpacing:"0.2em", textTransform:"uppercase", color:"var(--fg-subtle)", display:"block", marginBottom:"6px" }}>Email *</label>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                  <div>
                    <label style={{ fontFamily:"var(--font-mono)", fontSize:"0.65rem", letterSpacing:"0.2em", textTransform:"uppercase", color:"var(--fg-subtle)", display:"block", marginBottom:"6px" }}>Medium</label>
                  ...
                  <div>
                    <label style={{ fontFamily:"var(--font-mono)", fontSize:"0.65rem", letterSpacing:"0.2em", textTransform:"uppercase", color:"var(--fg-subtle)", display:"block", marginBottom:"6px" }}>Budget</label>
                ...
                <div className="mb-4">
                  <label style={{ fontFamily:"var(--font-mono)", fontSize:"0.65rem", letterSpacing:"0.2em", textTransform:"uppercase", color:"var(--fg-subtle)", display:"block", marginBottom:"6px" }}>Subject</label>
                  <input name="subject" value={form.subject} onChange={handleChange} placeholder="e.g. Character Commission" className="input-glass"/>
                </div>

                <div className="mb-6">
                  <label style={{ fontFamily:"var(--font-mono)", fontSize:"0.65rem", letterSpacing:"0.2em", textTransform:"uppercase", color:"var(--fg-subtle)", display:"block", marginBottom:"6px" }}>Message *</label>
                  <textarea name="message" value={form.message} onChange={handleChange}
                    placeholder="Describe your commission idea — style, subject, references, any details..."
                ...
                {status === "error" && (
                  <p className="mb-4 px-4 py-3 rounded-xl text-sm"
                    style={{ background:"rgba(229,62,62,0.08)", color:"#c53030", border:"1px solid rgba(229,62,62,0.2)" }}>
                    Something went wrong. Please email directly at {artistEmail}
                  </p>
                )}
                ...
                <p className="text-center mt-3" style={{ fontFamily:"var(--font-mono)", fontSize:"0.6rem", color:"var(--fg-subtle)" }}>
                  Saved to database · Replies within 48 hours
                </p>
              </form>
            )}
          </div>
